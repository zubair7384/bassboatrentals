...
const Pricing = ({ navigation }) => {
    const pricingData = [
        { title: "Hourly rental", price: "$100", description: "Take it with you by adding the trailer package" },
        { title: "8 Hours", price: "$400", description: "Take it with you by adding the trailer package" },
        { title: "1 Day (24 hours)", price: "$400", description: "Take it with you by adding the trailer package" },
        ...
        { title: "MOTOR HOURS (rental includes 1 hour per day, additional hours are extra)", price: "$50" },
    ];
