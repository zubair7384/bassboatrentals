    ...
    onSubmit: async values => {
      ...
      try {
        ...
        const boatData = {
          ...
          Boat_Description: values.Boat_Description,
          Max_Passengers_Capacity: values.Max_Passengers_Capacity,
          ...
          Boat_Rate: values.Boat_Rate,

          Boat_Make: values.Boat_Make,
          Boat_Model: values.Boat_Model,
          Boat_Year: values.Boat_Year,
          Boat_HIN: values.Boat_HIN,
          DriverOption: values.DriverOption,
          Motor_Make: values.Motor_Make,
          Motor_Model: values.Motor_Model,
          Motor_Year: values.Motor_Year,
          Motor_Serial: values.Motor_Serial,
          Trailer_Make: values.Trailer_Make,
          Trailer_Dual_Single_Axle: values.Trailer_Dual_Single_Axle,
          Trailer_Shocks: values.Trailer_Shocks,
          Trailer_Surge_Brakes: values.Trailer_Surge_Brakes,
          Trailer_Year: values.Trailer_Year,
          Trailer_VIN: values.Trailer_VIN,
          Trailer_Spare_Wheel: values.Trailer_Spare_Wheel,
          Tread_depths: values.Tread_depths,
          Trailer_Motor_Make: values.Trailer_Motor_Make,
          Trailer_Motor_Model: values.Trailer_Motor_Model,
          Trailer_Motor_Year: values.Trailer_Motor_Year,
          Spare_Trolling_Motor_Prop: values.Spare_Trolling_Motor_Prop,
          Big_Motor_Prop: values.Big_Motor_Prop,
          shallow_water_anchors: values.shallow_water_anchors,
          Anchor_Brand_Model: values.Anchor_Brand_Model,
          FFS_Make: values.FFS_Make,
          FFS_Model: values.FFS_Model,
          FFS_Year: values.FFS_Year,
          FFS_Graph1_Make: values.FFS_Graph1_Make,
          FFS_Graph1_Model: values.FFS_Graph1_Model,
          FFS_Graph1_Year: values.FFS_Graph1_Year,
          FFS_Graph2_Make: values.FFS_Graph2_Make,
          FFS_Graph2_Model: values.FFS_Graph2_Model,
          FFS_Graph2_Year: values.FFS_Graph2_Year,
          FFS_Graph3_Make: values.FFS_Graph3_Make,
          FFS_Graph3_Model: values.FFS_Graph3_Model,
          FFS_Graph3_Year: values.FFS_Graph3_Year,
          FFS_Graph4_Make: values.FFS_Graph4_Make,
          FFS_Graph4_Model: values.FFS_Graph4_Model,
          FFS_Graph4_Year: values.FFS_Graph4_Year,
          Insurance_Provider: values.Insurance_Provider,
          Owner_Policy_Named: values.Owner_Policy_Named,
          Policy_number: values.Policy_number,
          Policy_Liability_Acceptable: values.Policy_Liability_Acceptable,
